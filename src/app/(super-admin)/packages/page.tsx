      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Manage feature packages for projects</p>
          </div>
          <Button
            onClick={() => {
              setEditingPackage(null)
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50/50">
                      ...
                      <TableHead className="text-xs uppercase tracking-wide text-gray-500">Features</TableHead>
                      <TableHead className="text-xs uppercase tracking-wide text-gray-500">Status</TableHead>
                      <TableHead className="text-xs uppercase tracking-wide text-gray-500">Created</TableHead>
                      ...
                      return (
                        <TableRow key={pkg.id} className="hover:bg-gray-50">
                          <TableCell>
                            ...
                            {pkg.description && (
                              <p className="text-xs text-gray-400 mt-0.5 max-w-xs truncate">{pkg.description}</p>
                            )}
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell>
                            <span className="text-sm text-gray-500">{formatDate(pkg.created_at)}</span>
                          </TableCell>
                          <TableCell>
                            <div className="flex justify-end items-center gap-2">
                              ...
                              <Button
                                variant="ghost"
                                size="icon"
                                className={`h-8 w-8 ${pkg.is_active ? "text-green-600 hover:text-green-700 hover:bg-green-50" : "text-amber-500 hover:text-amber-600 hover:bg-amber-50"}`}

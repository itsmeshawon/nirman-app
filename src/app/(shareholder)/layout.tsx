    ...
    <div className="flex h-screen bg-[var(--background)] overflow-hidden">
      ...
      >
        ...
        <div className="flex h-16 shrink-0 items-center justify-between px-6">
          <Link href="/my/dashboard" className="flex items-center gap-2 mt-4 mb-4 pl-1 text-[var(--on-surface)]">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between bg-[var(--background)]/80 backdrop-blur-md px-4 sm:px-6 lg:px-8 shrink-0">
          <div className="flex items-center">
            <button
              className="mr-3 p-2 rounded-full text-[var(--on-surface)] lg:hidden hover:bg-[var(--surface-container-high)]"

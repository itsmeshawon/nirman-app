    ...
    <div className="space-y-8">
       ...
       <div className="border-b border-outline-variant/50">
         <nav className="flex space-x-4 sm:space-x-8 overflow-x-auto whitespace-nowrap pb-1">
            ...
            <button onClick={() => setActiveTab("HISTORY")} className={`py-4 border-b-2 font-medium text-sm transition-colors ${activeTab === "HISTORY" ? "border-primary text-primary" : "border-transparent text-on-surface-variant hover:text-on-surface"}`}>
               My Payment History
            </button>
         </nav>
      </div>

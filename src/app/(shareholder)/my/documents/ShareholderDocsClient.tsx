            ...
            {filteredDocs.length > 0 ? (
              filteredDocs.map((doc, idx) => (
                <TableRow key={doc.id} className="group hover:bg-primary-container/20/30 transition-colors">
                  <TableCell className="pl-6 text-on-surface-variant font-medium">{idx + 1}</TableCell>
                  <TableCell>
                    <div className="flex items-center">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-on-surface-variant uppercase md:hidden tracking-wider">
                ...
                <TableCell colSpan={5} className="h-64 text-center text-on-surface-variant">
                  <div className="flex flex-col items-center justify-center space-y-3">
                    <div className="p-4 rounded-full bg-surface-variant/20">
                      <FileText className="w-10 h-10 text-on-surface-variant-variant" />
                    </div>
